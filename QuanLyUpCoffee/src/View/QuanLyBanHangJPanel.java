...
public class QuanLyBanHangJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnThemDo.setText("Chọn sản phẩm");
...
////        //
    ...
    try {
        LoaiSanPham selectedLoaiSanPham = (LoaiSanPham) cboLoaidouong.getSelectedItem();
        List<SanPham> productList = DAOSP.selectByKeyword(txtTimkiem.getText(), selectedLoaiSanPham.getID_LoaiSP());

        for (SanPham product : productList) {
            model.addRow(new Object[]{
                    product.getId_sp(),
                    product.getTen_sp(),
                    DAOLSP.selectId_LSP(product.getId_loaiSP()).getTenLoai(),
                    formatCurrency(SanPhamGiamGia(product.getId_sp(), product.getGia_sp())),
                    formatCurrency(product.getGia_sp())
            });
        }
    } catch (Exception e) {
        e.printStackTrace();
...
private String formatCurrency(double amount) {
    // Use NumberFormat to format the currency
