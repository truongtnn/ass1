...
//       Hoadon hd = hddao.selectById(mahd);
        ...
        try {
            File newFile = new File("D:\\QuanLyUpCofffee\\printthongke\\baocaongay.pdf");
            PdfWriter.getInstance(document, new FileOutputStream(newFile.getAbsoluteFile().getPath()));
            document.open();
            Font f = new Font(BaseFont.createFont("D:\\QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f.setSize(16);
            Font f2 = new Font(BaseFont.createFont("D:\\QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f2.setSize(12);
            Font f3 = new Font(BaseFont.createFont("D:\\QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f3.setSize(10);
           
             Font f4 = new Font(BaseFont.createFont("D:\\QuanLyUpCofffee\\arialbd.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f4.setSize(14);
